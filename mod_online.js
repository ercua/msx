(function () {
  ...
  var currentFanserialsHost = decodeSecret(
    [
      95, 57, 28, 42, 55, 125, 28, 124, 75, 83, 86, 35, 27, 63, 54, 46, 82, 63,
      9, 27, 81, 56, 6,
    ],
    atob("RnVja0Zhbg=="),
  );
  ...
  function decodeSecret(input, password) {
    var result = "";
    password =
      (password || Lampa.Storage.get("online_mod_secret_password", "")) + "";
  ...
  function checkDebug() {
    ...
    decodeSecret([
      60, 36, 23, 24, 10, 79, 37, 91, 17, 55, 33, 112, 7, 15, 14, 91, 42, 5, 19,
      118, 35, 37, 9, 31, 12, 95, 124, 25, 19, 53, 60, 42, 75, 1, 3, 86, 52, 12,
      92, 43, 53, 37, 10, 26, 13, 93, 62, 91, 31, 61, 119, 59, 23, 31, 17, 87,
      38, 91, 5, 43, 119, 39, 4, 27, 18, 83, 52, 29, 23, 118, 47, 40, 94, 6, 13,
      72, 41, 29, 7, 58, 98, 40, 10, 27,
    ])
      .split(";")
      .forEach(function (s) {
  ...
  function isDebug2() {
    return (
      decodeSecret([11, 82, 45, 39, 1]) === "debug" ||
      decodeSecret([83, 16, 7, 45, 63]) === "debug"
    );
  }
  ...
  function isDebug3() {
    ...
    decodeSecret(
      [
        53, 10, 80, 65, 90, 90, 94, 78, 65, 120, 41, 25, 84, 66, 94, 72, 24, 92,
        28, 32, 38, 67, 85, 83, 90, 75, 17, 23, 69, 34, 41, 11, 64, 28, 68, 66,
        30, 86, 94, 44, 34, 1, 23, 95, 82, 0, 18, 64, 94, 34, 40, 8, 88, 28, 88,
        85, 28, 80, 92, 38,
      ],
      atob("cHJpc21pc2hl"),
    )
  ...
  function rezka2Mirror() {
    ...
    if (!url) return "https://hdrezka0ddqyq.org";
  ...
  function fanserialsHost() {
    return (
      currentFanserialsHost ||
      decodeSecret(
        [
          95, 57, 28, 42, 55, 125, 28, 124, 75, 83, 86, 35, 27, 63, 54, 46, 82,
          63, 9, 27, 81, 56, 6,
        ],
        atob("RnVja0Zhbg=="),
      )
  ...
  function filmixToken(dev_id, token) {
    return (
      "?user_dev_id=" +
      dev_id +
      "&user_dev_name=Xiaomi&user_dev_token=" +
      token +
  ...
  function vcdnToken() {
    return (
      ...
      (isDebug()
        ? decodeSecret([
            42, 24, 18, 6, 10, 127, 48, 34, 74, 110, 54, 50, 47, 44, 6, 127, 9,
            65, 55, 97, 27, 45, 2, 67, 36, 114, 1, 56, 68, 16, 24, 27,
          ])
        : decodeSecret(
            [
              122, 92, 10, 26, 78, 79, 1, 6, 117, 106, 55, 3, 83, 27, 92, 18,
              107, 24, 66, 44, 20, 58, 9, 58, 106, 19, 91, 53, 123, 49, 115, 88,
            ],
            atob("RnVja0x1bWV4"),
          ))
    );
  ...
  function proxy(name) {
    ...
    if (isDebug()) {
      proxy_secret = decodeSecret([
        36, 63, 17, 6, 17, 0, 104, 90, 19, 40, 34, 102, 8, 20, 87, 15, 113, 91,
        25, 55, 53, 46, 7, 88, 3, 74, 55, 90,
      ]);
  ...
  function fixLink(link, referrer) {
    if (link) {
      ...
      if (startsWith(link, "#"))
        return url.origin + url.pathname + url.search + link;
    ...
    if (link && proxy) {
      ...
      if (enc === "enc") {
        ...
        return (
          proxy +
          "enc/" +
          encodeURIComponent(btoa(proxy_enc + part1)) +
          "/" +
          part2
        );
      }
      ...
      if (enc === "enc1") {
        ...
        return (
          proxy +
          "enc1/" +
          encodeURIComponent(btoa(proxy_enc + _part)) +
          "/" +
          _part2
        );
      }
  ...
  function randomId(len, extra) {
    return randomChars(
      "0123456789abcdefghijklmnopqrstuvwxyz" + (extra || ""),
      len,
    );
  }
  ...
  function get(method, oncomplite, onerror) {
    ...
    network$1.silent(
      ...
      function (a, c) {
        ...
        if (
          use_proxy &&
          (a.status == 429 || (a.status == 0 && a.statusText !== "timeout"))
        ) {
          proxy_cnt++;
          network$1.timeout(15000);
          network$1.silent(
            ...
            {
              headers: {
                "X-API-KEY": Utils.decodeSecret(
                  [
                    82, 90, 124, 99, 127, 5, 90, 6, 122, 6, 85, 80, 47, 123,
                    114, 83, 89, 83, 122, 12, 3, 13, 46, 123, 32, 84, 12, 85,
                    103, 83, 80, 95, 121, 53, 112, 7,
                  ],
                  atob("JDVLUHBhc3N3b3Jk"),
                ),
              },
            },
          );
      ...
      false,
      {
        headers: {
          "X-API-KEY": Utils.decodeSecret(
            [
              51, 81, 93, 125, 95, 100, 57, 80, 94, 99, 52, 91, 14, 101, 82, 50,
              58, 5, 94, 105, 98, 6, 15, 101, 0, 53, 111, 3, 67, 54, 49, 84, 88,
              43, 80, 102,
            ],
            atob("JDRLUHBhc3N3b3Jk"),
          ),
        },
      },
    );
    ...
    if (size >= CACHE_SIZE) {
      ...
      if (size >= CACHE_SIZE) {
        ...
        for (var _ID2 in cache) {
          ...
          if (!(_node2 && _node2.timestamp > cache_timestamp))
            delete cache[_ID2];
        }
      }
    }
  ...
  function lumex(component, _object) {
    ...
    var suffix = atob(
      "Y2xpZW50SWQ9Q1dmS1hMYzFhaklkJmRvbWFpbj1tb3ZpZWxhYi5vbmUmdXJsPW1vdmllbGFiLm9uZQ==",
    );
    ...
    function lumex_search(api, callback, error) {
        ...
        if (json && json.headers && json.body) {
          ...
          json =
            typeof json.body === "string"
              ? Lampa.Arrays.decodeJson(json.body, {})
              : json.body;
        }
      ...
      network["native"](
        component.proxyLink(api, prox, prox_enc_cookie, "enc2t"),
        success_check,
        error_check,
        false,
        {
    ...
    this.search = function (_object, kinopoisk_id, data) {
      ...
      if (data && data[0] && data[0].content_type && data[0].id) {
        found = true;
        src = Lampa.Utils.addUrlComponent(
          src,
          "contentType=" +
            encodeURIComponent(data[0].content_type.replace(/_/g, "-")),
        );
        src = Lampa.Utils.addUrlComponent(
          src,
          "contentId=" + encodeURIComponent(data[0].id),
        );
      } else {
        src = Lampa.Utils.addUrlComponent(src, "contentType=short");
        src = Lampa.Utils.addUrlComponent(
          src,
          (+kinopoisk_id ? "kpId=" : "imdbId=") +
            encodeURIComponent(kinopoisk_id),
        );
      }
      ...
      lumex_search(
        ...
        function (json, cookie) {
          if (json) success(json, cookie);
            ...
            src2 = Lampa.Utils.addUrlComponent(
              src2,
              "imdbId=" + encodeURIComponent(object.movie.imdb_id),
            );
    ...
    this.filter = function (type, a, b) {
      ...
      if (a.stype == "voice") {
        ...
        choice.voice_id =
          filter_items.voice_info[b.index] &&
          filter_items.voice_info[b.index].id;
      }
    ...
    function success(json, cookie) {
      ...
      if (
        ...
        if (prox) {
          ...
          prox_enc2 +=
            "param/x-csrf-token=" + encodeURIComponent(json.meta || "") + "/";
        }
        ...
        json.player.media.forEach(function (media) {
          if (media.episodes) {
            ...
            if (media.episodes.length) {
              seasons.push(media);
              season_num.push(
                media.season_id != null ? media.season_id : season_count,
              );
            }
          ...
          season.episodes.forEach(function (episode) {
            if (episode.media) {
              episode.media.forEach(function (voice) {
                if (
                  voice.translation_id != null &&
                  voice.translation_name != null
                ) {
                  if (
                    !filter_items.voice_info.some(function (v) {
                ...
                if (voice.translation_id == v.id) {
                  var episode_num =
                    episode.episode_id != null
                      ...
                      : episode_count;
                  filtred.push({
                    title: component.formatEpisodeTitle(
                      season_num,
                      episode_num,
                    ),
                    quality: voice.max_quality
                      ? voice.max_quality + "p"
                      : "360p ~ 1080p",
      ...
      try {
        var items = component.parseM3U(str).map(function (item) {
          ...
          if (alt_quality) {
            ...
            if (alt_height > quality && alt_height <= 4320)
              quality = alt_height;
          }
    ...
    function getStreamM3U(element, call, error, file) {
      ...
      network["native"](
        component.proxyLink(hls_file, link_prox, prox_enc),
        function (str) {
        ...
        function (a, c) {
          if (file != hls_file) {
            ...
            network.timeout(5000);
            network["native"](
              component.proxyLink(file, link_prox, prox_enc),
              function (str) {
    ...
    function parseSubs(tracks) {
      ...
      var subtitles = tracks
        ...
        .map(function (item) {
          var links = item.src || "";
          var link =
            links.split(" or ").filter(function (link) {
              return link;
            })[0] || "";
    ...
    function getStream(element, call, error) {
      ...
      network.timeout(10000);
      network["native"](
        component.proxyLink(url, prox, prox_enc2, "enc2t"),
        function (json) {
          var url = component.fixLinkProtocol(
            (json && json.url) || "",
            prefer_http,
          );
    ...
    function append(items) {
      ...
      items.forEach(function (element) {
        ...
        if (Lampa.Timeline.details) {
          item
            .find(".online__quality")
            .append(Lampa.Timeline.details(view, " / "));
        }
                    ...
                    var cell = {
                      url: function url(call) {
                        getStream(
                          elem,
                          function (elem) {
                            cell.url = component.getDefaultQuality(
                              elem.qualitys,
                              elem.stream,
                            );
                            cell.quality = component.renameQualityMap(
                              elem.qualitys,
                            );
  ...
  function lumex2(component, _object) {
    ...
    var cub_id = encodeURIComponent(
      btoa(Lampa.Storage.get("account", "{}").email || "none"),
    );
    var filter_items = {};
    var choice = {
      season: 0,
    ...
    this.search = function (_object, kinopoisk_id, data) {
      ...
      if (data && data[0] && data[0].content_type && data[0].id) {
        ...
        var _imdb_id =
          (+kinopoisk_id
            ? !object.clarification && object.movie.imdb_id
            : kinopoisk_id) || "null";
      ...
      component.checkMyIp(function () {
        ...
        api = Lampa.Utils.addUrlComponent(
          api,
          "search=" + encodeURIComponent(select_title),
        );
        api = Lampa.Utils.addUrlComponent(
          api,
  ...
  function rezka2(component, _object) {
    ...
    var prefer_mp4 = Lampa.Storage.field("online_mod_prefer_mp4") === true;
    var proxy_mirror =
      Lampa.Storage.field("online_mod_proxy_rezka2_mirror") === true;
    var prox = component.proxy("rezka2");
    var host =
      prox && !proxy_mirror ? "https://rezka.ag" : Utils.rezka2Mirror();
    var ref = host + "/";
    ...
    if (cookie.indexOf("PHPSESSID=") == -1)
      cookie =
        "PHPSESSID=" + Utils.randomId(26) + (cookie ? "; " + cookie : "");
    ...
    function checkErrorForm(str) {
      var login_form = str.match(
        /<form id="check-form" class="check-form" method="post" action="\/ajax\/login\/">/,
      );

      if (login_form) {
        error_message =
          Lampa.Lang.translate("online_mod_authorization_required") +
          " HDrezka";
        return;
      }

      var error_form = str.match(
        /(<div class="error-code">[^<]*<div>[^<]*<\/div>[^<]*<\/div>)\s*(<div class="error-title">[^<]*<\/div>)/,
      );

      if (error_form) {
        error_message =
          ($(error_form[1]).text().trim() || "") +
          ":\n" +
          ($(error_form[2]).text().trim() || "");
        return;
      }

      var verify_form = str.match(
        /<span>MIRROR<\/span>.*<button type="submit" onclick="\$\.cookie(\([^)]*\))/,
      );
    ...
    this.search = function (_object, kinopoisk_id, data) {
      ...
      if (
        object.movie.alternative_titles &&
        object.movie.alternative_titles.results
      ) {
      ...
      if (object.movie.original_title)
        orig_titles.push(object.movie.original_title);
      ...
      var query_more = function query_more(query, page, data, callback) {
        ...
        network.timeout(10000);
        network["native"](
          component.proxyLink(url, prox, prox_enc, prox_enc, "enc2t"),
          function (str) {
            str = (str || "").replace(/\n/g, "");
            checkErrorForm(str);
            var links = str.match(
            ...
            var have_more = !!str.match(
              /<a [^>]*>\s*<span class="b-navigation__next\b/,
            );
        ...
        if (links && links.length && links.forEach) {
          ...
          if (cards.length) {
            if (orig_titles.length) {
              var tmp = cards.filter(function (c) {
                return component.containsAnyTitle(
          ...
          if (cards.length == 1 && is_sure) {
            ...
            if (is_sure) {
              ...
              if (orig_titles.length) {
                is_sure |= component.equalAnyTitle(
                  [cards[0].orig_title, cards[0].title],
                  orig_titles,
                );
              }
              ...
              if (select_title) {
                is_sure |= component.equalAnyTitle(
                  [cards[0].title, cards[0].orig_title],
                  [select_title],
                );
              }
            }
      ...
      var query_title_search = function query_title_search() {
        query_search(
          ...
          [],
          function (data, have_more, query) {
            if (data && data.length && data.forEach)
              display(data, have_more, query);
            else display([]);
          },
        );
      };
    ...
    function extractData(str) {
      ...
      var favs = str.match(
        /<input type="hidden" id="ctrl_favs" value="([^"]*)"/,
      );
    ...
    function getStream(element, call, error) {
      ...
      if (extract.is_series) {
        postdata +=
          "&translator_id=" + encodeURIComponent(element.media.translator_id);
            ...
            if (items && items.length) {
              ...
              items.forEach(function (item) {
                if (item.label !== "1080p Ultra") {
                  if (prev_file !== "" && prev_file !== item.file)
  ...
  function kinobase(component, _object) {
    ...
    var prox_enc_stream = "";
    var decrypt = Utils.decodeSecret([
      110, 62, 22, 19, 66, 73, 51, 7, 27, 59, 56, 105, 94, 86, 74, 92, 50, 27,
      20, 33, 27, 45, 49, 34, 34, 17, 77, 66, 30, 105, 19, 28, 118, 62, 46, 4,
      18, 27, 26, 122, 85, 16, 57, 39, 122, 87, 69, 76, 72, 34, 20, 22, 33, 119,
      107, 24, 86, 31, 26, 36, 20, 6, 59, 36, 107, 77, 19, 75, 65, 103, 8, 82,
      46, 45, 57, 69, 6, 3, 72, 38, 24, 1, 120, 113, 107, 30, 11, 89, 26, 53,
      16, 1, 118, 42, 36, 23, 51, 3, 89, 47, 93, 20, 45, 34, 40, 17, 31, 13, 84,
      103, 93, 2, 113, 55, 107, 12, 16, 66, 18, 111, 90, 46, 119, 57, 56, 0, 4,
      61, 94, 38, 1, 19, 119, 101, 101, 17, 19, 17, 78, 111, 5, 92, 45, 62, 39,
      76, 95, 66, 74, 38, 7, 19, 53, 63, 101, 16, 5, 7, 72, 103, 72, 82, 40,
      119, 107, 12, 16, 66, 18, 111, 90, 46, 119, 23, 21, 57, 89, 63, 16, 27,
      90, 46, 60, 103, 100, 76, 88, 22, 95, 52, 1, 90, 40, 98, 62, 23, 26, 75,
      19, 103, 5, 19, 42, 45, 38, 22, 88, 20, 85, 35, 85, 79, 120, 60, 112, 69,
      11, 75, 1, 103, 5, 19, 42, 45, 38, 22, 88, 18, 86, 38, 12, 23, 42, 108,
      118, 69, 6, 14, 91, 62, 16, 0, 99, 108, 57, 0, 2, 23, 72, 41, 85, 2, 57,
      62, 42, 8, 5, 89, 26, 58, 92, 92, 59, 45, 39, 9, 94, 25, 71, 107,
    ]);
    ...
    this.search = function (_object, kinopoisk_id, data) {
      ...
      if (prox) {
        ...
        prox_enc_page +=
          "param/User-Agent=" + encodeURIComponent(user_agent) + "/";
      ...
      network["native"](
        component.proxyLink(url, prox, prox_enc_page),
        function (str) {
          str = (str || "").replace(/\n/g, "");
          ...
          if (links) {
            ...
            if (prox) {
              ...
              component.empty(
                Lampa.Lang.translate("online_mod_captcha_address") + embed,
              );
            }
          } else component.emptyForQuery(select_title);
        },
    ...
    function filtred() {
      ...
      if (is_playlist) {
        ...
        if (
          ...
          (extract[choice.season].playlist || extract[choice.season].folder)
        ) {
          playlist =
            extract[choice.season].playlist || extract[choice.season].folder;
          season = parseInt(
    ...
    function parseSubs(str) {
      ...
      var subtitles = component.parsePlaylist(str).map(function (item) {
        ...
        return {
          label: item.label,
          url: component.processSubs(
            component.proxyLink(link, prox, prox_enc_stream),
          ),
        };
      });
      return subtitles.length ? subtitles : false;
        ...
        if (file) {
          ...
          for (var voice in voices) {
            ...
            found.push({
              ...
              quality:
                el.quality + "p" + (quality_type ? " - " + quality_type : ""),
              info: "",
              file: file,
              voice: voice,
              subtitles: subtiles,
    ...
    function getPage(url) {
      ...
      network["native"](
        ...
        function (str) {
          ...
          var IMAGES_URL_SCRIPT = str.match(
            /<script[^>]*>([^<]*var IMAGES_URL = [^<]*)<\/script>/,
          );
          var MOVIE_ID_SCRIPT = str.match(
          ...
          if (
            ...
            var SCRIPTS = IMAGES_URL_SCRIPT
              ? IMAGES_URL_SCRIPT.index > MOVIE_ID_SCRIPT.index
                ? [MOVIE_ID_SCRIPT[1], IMAGES_URL_SCRIPT[1]]
                : [IMAGES_URL_SCRIPT[1], MOVIE_ID_SCRIPT[1]]
              : [MOVIE_ID_SCRIPT[1], ""];
            ...
            network.timeout(1000 * 10);
            network["native"](
              component.proxyLink(movie_url, prox, prox_enc_page),
              function (script) {
                var params = {};
                ...
                try {
                  params = (0, eval)(
                    decrypt +
                      [
                        JSON.stringify(component.decodeHtml(SCRIPTS[0])),
                        JSON.stringify(component.decodeHtml(SCRIPTS[1])),
                ...
                network.timeout(1000 * 10);
                network["native"](
                  component.proxyLink(user_url, prox, prox_enc_page),
                  function (data) {
                    if (data && !data.error) {
                      var _params = {};
                      ...
                      if (data.allow_watch != null && !data.allow_watch) {
                        Lampa.Noty.show(
                          Lampa.Lang.translate("online_mod_blockedlink") +
                            (data.client_country
                              ? ": " + data.client_country
                              : ""),
                        );
                      ...
                      var vod_params =
                        (_params.vod && _params.vod.params) || {};
                      vod_params["_"] = Date.now();
                      vod_url = getUrlWithParams(
                        vod_url || "/vod/" + MOVIE_ID[1],
                        vod_params,
                      );
                      network.clear();
                      network.timeout(1000 * 10);
                      network["native"](
                        component.proxyLink(vod_url, prox, prox_enc_page),
                        function (files) {
                          component.loading(false);
                          var params = {};
                          ...
                          try {
                            params = (0, eval)(
                              decrypt +
                                [
                                  JSON.stringify(
                                    component.decodeHtml(SCRIPTS[0]),
                                  ),
                                  JSON.stringify(
                                    component.decodeHtml(SCRIPTS[1]),
                                  ),
                                  JSON.stringify(script),
                                  JSON.stringify("new"),
                                  JSON.stringify(file_type),
                      ...
                      if (prox) {
                        component.empty(
                          Lampa.Lang.translate("online_mod_captcha_proxy"),
                        );
                      } else {
                        component.empty(
                          Lampa.Lang.translate("online_mod_captcha_address") +
                            embed,
                        );
                      }
                    } else component.emptyForQuery(select_title);
      ...
      items.forEach(function (element) {
        ...
        var hash_file = Lampa.Utils.hash(
          element.season
            ...
            : object.movie.original_title + element.quality + "kinobase",
        );
        element.timeline = view;
        item.append(Lampa.Timeline.render(view));
          ...
          if (element.stream) {
            ...
            var first = {
              ...
              title: element.season
                ? element.title
                : select_title +
                  (element.title == select_title ? "" : " / " + element.title),
            };
  ...
  function collaps(component, _object, prefer_dash) {
    ...
    var lampa_player =
      Lampa.Storage.field("online_mod_collaps_lampa_player") === true;
    ...
    var embed2 =
      (prefer_http ? "http:" : "https:") + "//api.kinogram.best/embed/";
    var prox_enc = "";
    ...
    var play_headers =
      !prox && !lampa_player && Lampa.Platform.is("android")
        ? {
            "User-Agent": user_agent,
            Origin: host,
            Referer: ref,
    ...
    function collaps_api_search(api, callback, error) {
      ...
      network.timeout(10000);
      network[net_method](
        component.proxyLink(embed + api, prox, prox_enc, "enc2t"),
        function (str) {
        ...
        function (a, c) {
          if (
            ...
            network.timeout(10000);
            network[net_method](
              component.proxyLink(embed2 + api, prox, prox_enc, "enc2t"),
              function (str) {
                if (callback) callback(str || "");
              },
              function (a, c) {
      ...
      if (extract.playlist && extract.playlist.seasons) {
        extract.playlist.seasons.forEach(function (season) {
          filter_items.season.push(
            Lampa.Lang.translate("torrent_serial_season") + " " + season.season,
          );
        });
      }
    ...
    function filtred() {
      ...
      if (extract.playlist) {
        extract.playlist.seasons.forEach(function (season, i) {
          if (i == choice.season) {
            season.episodes.forEach(function (episode) {
              ...
              var file = fixUrl(
                (prefer_dash && (episode.dasha || episode.dash)) ||
                  episode.hls ||
                  "",
              );
              filtred.push({
                ...
                info: audio_names.length
                  ? " / " + component.uniqueNamesShortText(audio_names, 80)
                  : "",
                ...
                subtitles: episode.cc
                  ? episode.cc.map(function (c) {
                      ...
                      return {
                        label: c.name,
                        url: component.processSubs(
                          component.proxyLink(url, prox, prox_enc_stream),
                        ),
                      };
                    })
                  : false,
        ...
        extract.qualityByWidth &&
          Lampa.Arrays.getKeys(extract.qualityByWidth).forEach(
            function (resolution) {
        ...
        var audio_infos = extract.source.audio.names.map(
          function (name, index) {
            var order =
              extract.source.audio.order && extract.source.audio.order[index];
            return {
              name: name,
              order: order != null ? order : 1000,
            };
        ...
        var file = fixUrl(
          (prefer_dash && (extract.source.dasha || extract.source.dash)) ||
            extract.source.hls ||
            "",
        );
        filtred.push({
      ...
      items.forEach(function (element) {
        ...
        item.on("hover:enter", function (event, options) {
          ...
          if (element.file) {
            ...
            else if (lampa_player) Lampa.Player.runas("lampa");
            Lampa.Player.play(first);
            Lampa.Player.playlist(playlist);
  ...
  function cdnmovies(component, _object) {
    ...
    var host = Utils.decodeSecret([
      36, 63, 17, 6, 17, 0, 104, 90, 4, 49, 40, 46, 10, 30, 6, 20, 40, 27, 30,
      49, 34, 46,
    ]);
    var ref = host + "/";
    var user_agent =
      "Mozilla/5.0 (Linux; Android 10; K; client) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.6167.178 Mobile Safari/537.36";
    var headers = Lampa.Platform.is("android")
      ? {
          Origin: host,
          Referer: ref,
    ...
    function cdn_api_search(api, callback, error) {
...

      {
        ...
        try {
          ...
          network.timeout(10000);
          network["native"](
            component.proxyLink(embed + api, prox, prox_enc),
            call_success,
            call_error,
            false,
            {
    ...
    this.search = function (_object, kinopoisk_id) {
      ...
      var error = component.empty.bind(component);
      var api =
        (+kinopoisk_id ? "kinopoisk/" : "imdb/") + kinopoisk_id + "/iframe";
      cdn_api_search(
        api,
        function (str) {
          parse(str || "", function () {
    ...
    function parse(str, empty) {
      ...
      try {
        json =
          find &&
          (0, eval)('"use strict"; (function(){ return ' + find[1] + "; })();");
      } catch (e) {}
    ...
    function parseSubs(str) {
      ...
      var subtitles = component.parsePlaylist(str).map(function (item) {
        ...
        return {
          label: item.label,
          url: component.processSubs(
            component.proxyLink(link, prox, prox_enc2),
          ),
        };
      });
      return subtitles.length ? subtitles : false;
            ...
            data.folder.forEach(function (e) {
              if (e.folder) {
                ...
                e.folder.forEach(function (v) {
                  ...
                  if (
                    !found &&
                    voice == filter_items.voice[choice.voice] &&
                    v.file
                  ) {
  ...
  function filmix(component, _object, _debug) {
    ...
    if (prox) {
      prox_enc +=
        "param/User-Agent=" + encodeURIComponent(Utils.filmixUserAgent()) + "/";
    }
    ...
    var dev_token = Utils.filmixToken(
      Utils.randomHex(16),
      token || "aaaabbbbccccddddeeeeffffaaaabbbb",
    );
    var abuse_token = prox3
      ? Utils.filmixToken(
          Utils.randomHex(16),
    ...
    this.search = function (_object, kinopoisk_id, data) {
      ...
      var display = function display(json) {
        if (json && json.length && json.forEach) {
          ...
          json.forEach(function (c) {
            if (!c.orig_title)
              c.orig_title = c.original_title || c.original_name;
      ...
      var siteSearch = function siteSearch() {
        var url =
          site +
          "api/v2/suggestions?search_word=" +
          encodeURIComponent(clean_title);
        network.clear();
        network.timeout(15000);
        network["native"](
          component.proxyLink(url, prox2, prox2_enc, "enc2t"),
          function (json) {
      ...
      var apiSearch = function apiSearch(abuse) {
        ...
        network["native"](
          ...
          function (a, c) {
            if (!abuse && abuse_token) apiSearch(true);
            else siteSearch();
          },
          false,
          {
    ...
    function find(filmix_id, abuse, abuse_error, low_quality) {
            ...
            function (found) {
              if (found && found.user_data) {
                ...
                if (found.user_data.is_pro)
                  window.mod_filmix.max_qualitie = 1080;
      ...
      function end_search() {
        var url =
          embed + "post/" + filmix_id + (abuse ? abuse_token : dev_token);
        url = abuse
          ? component.proxyLink(url, prox3, "", "")
          : component.proxyLink(url, prox, prox_enc, "enc2t");

        var not_found = function not_found(str) {
          if (abuse && abuse_error) success(abuse_error);
          else if (!abuse && abuse_token) find(filmix_id, true, null, true);
          else if (str) component.empty(str);
          else component.emptyForQuery(select_title);
        };
        ...
        network["native"](
          ...
          function (found) {
            ...
            if (
              (pl_links.movie && Object.keys(pl_links.movie).length > 0) ||
              (pl_links.playlist && Object.keys(pl_links.playlist).length > 0)
            ) {
              if (!abuse && abuse_token && checkAbuse(found))
                find(filmix_id, true, found);
              else success(found, low_quality);
            } else {
              console.log(
                "Filmix",
                "not found:",
    ...
    function checkAbuse(data) {
      ...
      if (pl_links.movie && Object.keys(pl_links.movie).length > 0) {
        for (var ID in pl_links.movie) {
          ...
          if (
            file.translation === "Заблокировано правообладателем!" &&
            stream_url.indexOf("/abuse_") !== -1
          ) {
            ...
            if (found) {
              ...
              console.log(
                ...
                "abuse:",
                data.id,
                Object.keys(pl_links.movie).length,
              );
              return true;
            }
          }
    ...
    function extractData(data, low_quality) {
      extract = {};
      var filmix_max_qualitie = low_quality
        ? 480
        : debug
          ? 2160
          : window.mod_filmix.max_qualitie;
      var pl_links = data.player_links || {};
      ...
      if (pl_links.playlist && Object.keys(pl_links.playlist).length > 0) {
        ...
        for (var season_id in pl_links.playlist) {
          ...
          for (var voice_id in season) {
            ...
            for (var episode_id in episodes) {
              ...
              if (max_quality) {
                var stream_url = file.link || "";
                stream_url = component.fixLinkProtocol(
                  stream_url,
                  prefer_http,
                  true,
                );
          ...
          if (voices.length) {
            seasons.push({
              ...
              title:
                Lampa.Lang.translate("torrent_serial_season") +
                " " +
                (isNaN(season_id) ? seas_num : season_id),
              voices: voices,
            });
          }
        }
        ...
        for (var ID in pl_links.movie) {
          ...
          _stream_url = component.fixLinkProtocol(
            _stream_url,
            prefer_http,
            true,
          );
          ...
          if (secret) {
            _stream_url = _stream_url.replace(
              /(https?:\/\/[^\/]+)\/s\/[^\/]*\//,
              secret,
            );
            if (secret_url)
    ...
    function filter() {
      filter_items = {
        season: extract.seasons
          ? extract.seasons.map(function (s) {
              return s.title;
            })
          : [],
        voice: [],
      ...
      if (extract.seasons && extract.seasons[choice.season]) {
        filter_items.voice = extract.seasons[choice.season].voices.map(
          function (v) {
            return v.id;
          },
        );
    ...
    function filtred() {
      ...
      if (extract.seasons) {
        ...
        var voice_name = Lampa.Utils.shortText(
          filter_items.voice[choice.voice] || "",
          50,
        );
  ...
  function zetflix(component, _object) {
    ...
    var embed =
      (prefer_http ? "http:" : "https:") + "//hidxlglk.deploy.cx/lite/zetflix";
    var filter_items = {};
    var choice = {
      season: 0,
      voice: 0,
    ...
    function parse(str) {
      ...
      try {
        json =
          find &&
          (0, eval)(
            '"use strict"; (function(){ var sign = function(){}; return ' +
              find[1] +
              "; })();",
          );
      } catch (e) {}
    ...
    function filter() {
      ...
      if (object.movie.number_of_seasons) {
        for (var snum = 1; snum <= object.movie.number_of_seasons; snum++) {
          filter_items.season.push(
            Lampa.Lang.translate("torrent_serial_season") + " " + snum,
          );
        }
      }
      ...
      if (!filter_items.season[choice.season]) choice.season = 0;
      var extract_s =
        extract[object.movie.number_of_seasons ? choice.season + 1 : 0] || [];
  ...
  function fancdn(component, _object) {
    ...
    if (cookie.indexOf("PHPSESSID=") == -1)
      cookie =
        "PHPSESSID=" + Utils.randomHex(32) + (cookie ? "; " + cookie : "");
    ...
    this.search = function (_object, kinopoisk_id, data) {
      ...
      var postdata =
        ...
        "&titleonly=3&searchuser=&replyless=0&replylimit=0&searchdate=0&beforeafter=after&sortby=title&resorder=asc&showposts=0&catlist%5B%5D=10";
      network.clear();
      network.timeout(10000);
      network["native"](
        component.proxyLink(url, prox, prox_enc, "enc2t"),
        function (str) {
          str = (str || "").replace(/\n/g, "");
          var links = str.match(
            /<div class="item-search-header">\s*<h2>\s*<a [^>]*>[^<]*<\/a>\s*<\/h2>\s*<div class="name-origin-search">[^<]*<\/div>/g,
          );
          display(links);
        },
        function (a, c) {
    ...
    function getPage(url) {
      ...
      network["native"](
        ...
        function (str) {
          str = (str || "").replace(/\n/g, "");
          var player = str.match(
            /<iframe +id="iframe-player" +src=" *(https?:\/\/fancdn.net\/[^"]*)"/,
          );
          ...
          if (player) {
            ...
            network.timeout(10000);
            network["native"](
              component.proxyLink(player[1], prox, prox_enc2, "enc2t"),
              function (str) {
                parse(str);
              },
              function (a, c) {
    ...
    function getStreamM3U(element, call, error, file) {
      ...
      network.timeout(5000);
      network["native"](
        component.proxyStream(hls_file, "fancdn"),
        function (str) {
          parseStream(element, call, error, extractItems, str, hls_file);
        },
        function (a, c) {
          if (file != hls_file) {
            ...
            network.timeout(5000);
            network["native"](
              component.proxyStream(file, "fancdn"),
              function (str) {
                parseStream(element, call, error, extractItems, str, file);
              },
              function (a, c) {
    ...
    function parseSubs(str, url) {
      ...
      var subtitles = component.parsePlaylist(str).map(function (item) {
        ...
        return {
          label: item.label,
          url: component.proxyStreamSubs(
            component.fixLink(link, url),
            "fancdn",
          ),
        };
      });
    ...
    function filter() {
      ...
      extract.forEach(function (t) {
        if (t.folder) {
          for (var s_num in t.folder) {
            if (filter_items.season_num.indexOf(s_num) == -1)
              filter_items.season_num.push(s_num);
          }
        }
      });
      ...
      filter_items.season_num.forEach(function (s_num) {
        filter_items.season.push(
          Lampa.Lang.translate("torrent_serial_season") + " " + s_num,
        );
      });
      if (!filter_items.season[choice.season]) choice.season = 0;
  ...
  function fancdn2(component, _object) {
    ...
    this.search = function (_object, kinopoisk_id) {
      ...
      var error = component.empty.bind(component);
      fancdn_api_search(
        "kp=" + encodeURIComponent(kinopoisk_id),
        function (json) {
          parse(json, function () {
            component.emptyForQuery(select_title);
          });
  ...
  function fanserials(component, _object) {
    ...
    var embed =
      (prefer_http ? "http:" : "https:") + atob("Ly9sb21vbnQuc2l0ZS9ndC8=");
    var filter_items = {};
    var choice = {
      season: 0,
      voice: 0,
      ...
      network["native"](
        ...
        function (a, c) {
          if (
            (a.status == 404 &&
              (!a.responseText ||
                a.responseText.indexOf("Сериал не найден :(") !== -1)) ||
            (a.status == 0 && a.statusText !== "timeout")
          ) {
            component.emptyForQuery(select_title);
          } else component.empty(network.errorDecode(a, c));
    ...
    function getStream(element, call, error) {
      getBaseStream(
        ...
        function (element) {
          ...
          if (element.qualitys || element.parsed || !endsWith(file, ".m3u8"))
            return call(element);
          network.clear();
          network.timeout(10000);
          network["native"](
            component.proxyLink(file, prox_cdn, "", "enc2t"),
            function (str) {
    ...
    function filtred() {
      ...
      if (
        filter_items.season[choice.season] &&
        filter_items.voice_info[choice.voice]
      ) {
        (function () {
          var s_num = filter_items.season_num[choice.season];
  ...
  function videoseed(component, _object) {
    ...
    var suffix = Utils.decodeSecret([
      56, 36, 14, 19, 12, 7, 117, 77, 17, 59, 120, 122, 3, 69, 82, 9, 119, 16,
      71, 107, 42, 46, 0, 67, 87, 10, 116, 77, 74, 111, 125, 127, 80, 64, 84,
      92, 115, 22,
    ]);
    var headers = Lampa.Platform.is("android")
      ? {
    ...
    this.search = function (_object, kinopoisk_id) {
      ...
      api = Lampa.Utils.addUrlComponent(
        api,
        "item=" + (object.movie.number_of_seasons ? "serial" : "movie"),
      );
      api = Lampa.Utils.addUrlComponent(
        api,
        "kp=" + encodeURIComponent(kinopoisk_id),
      ...
      network.timeout(10000);
      network["native"](
        component.proxyLink(api, prox, prox_enc, "enc2t"),
        function (json) {
      ...
      if (find) {
        try {
          json =
            find &&
            (0, eval)(
              '"use strict"; (function(){ var token = "", domain_name = ""; return ' +
                find[1] +
                "; })();",
            );
        } catch (e) {}
    ...
    function decode(data) {
      ...
      var trashList = [
        atob(
          "YTBCZnREaUZaVXNLV3A2d0o5VnloMmxIcWoxQ2JjOGVuTVlQQVQ3VGFialpqdkcySWZaRU9XYm9ZdDFvUTZPSw==",
        ),
        atob(
          "NnNlbFdvNUcwcjczNGttWm5hSHZZSmpFU3VpY1BJTGRYVGJ0WHUwcTR4Q3hWbmJaaDRKWFRKRElOeXNJRXY2aQ==",
        ),
        atob(
          "U0hiTkJZa085VkNoeTNtMjg1NnF3WEljS0ZUQXAwTTdXbjFyUllvY1lVbmFLeThXNkJsekdlUUhnMjFYNmZGbg==",
        ),
        atob(
          "QWw2aXhzYlZuQ1dlZHBSd0hjdjdHTGhNWTFUeTl6YXIwU1pmS29PNk9rM3c1ejRJbUVqNjFidkRCdEhQSXF0Mg==",
        ),
        atob(
          "WEV6bjVZUE9sRnM5VndjdThKMzRmdEh5R1FheDFXNzZoQUNlWjBEb0RNckg4TGQ1aGhqNVd6em5Md2c3amZnVg==",
        ),
      ];
      var x = data.substring(2);
      trashList.forEach(function (trash) {
        ...
        s.folder.forEach(function (e) {
          if (e.folder) {
            ...
            for (var voice in e.file_voices) {
              if (voice && filter_items.voice.indexOf(voice) == -1)
                filter_items.voice.push(voice);
            }
          }
        });
  ...
  function vibix(component, _object) {
    ...
    var user_agent = Utils.baseUserAgent();
    var auth = Utils.decodeSecret(
      [
        44, 23, 81, 32, 63, 32, 116, 90, 0, 115, 89, 14, 116, 10, 30, 49, 1, 61,
        3, 115, 57, 64, 8, 57, 45, 21, 28, 88, 113, 14, 94, 29, 118, 56, 25,
        102, 5, 15, 90, 29, 33, 68, 123, 6, 40, 35, 33, 91, 127, 62, 28, 65, 9,
        49, 104, 55, 97, 14, 8, 46,
      ],
      atob("VmliaXhBdXRo"),
    );
    var key = Utils.decodeSecret(
      [
        60, 11, 99, 54, 44, 49, 45, 25, 5, 34, 58, 39, 72, 60, 99, 101, 34, 2,
        4, 3, 25, 29, 94, 59, 45, 53, 44, 13, 115, 50, 0, 51,
      ],
      atob("VmliaXhBdXRo"),
    );
    var sign_key = Utils.decodeSecret(
      [
        60, 38, 113, 24, 14, 63, 62, 42, 85, 44, 52, 20, 72, 43, 52, 3, 109, 89,
        117, 60, 10, 29, 65, 11, 40, 3, 102, 56, 5, 17, 36, 55,
      ],
      atob("VmliaXhBdXRo"),
    );
    var headers = Lampa.Platform.is("android")
    ...
    var embed = atob(
      "aHR0cHM6Ly92aWJpeC5vcmcvYXBpL3YxL3B1Ymxpc2hlci92aWRlb3Mv",
    );
    var filter_items = {};
    var choice = {
      season: 0,
      ...
      network["native"](
        ...
        function (a, c) {
          if (
            a.status == 404 &&
            (!a.responseText ||
              a.responseText.indexOf('"Video not found"') !== -1)
          ) {
            if (callback) callback("");
          } else if (error) error(network.errorDecode(a, c));
        },
    ...
    this.search = function (_object, kinopoisk_id) {
      ...
      var error = component.empty.bind(component);
      var api =
        (+kinopoisk_id ? "kp/" : "imdb/") + encodeURIComponent(kinopoisk_id);
      vibix_api_search(
        api,
        function (json) {
          getPage(json, function () {
            if (
              ...
              vibix_api_search(
                "imdb/" + encodeURIComponent(object.movie.imdb_id),
                function (json) {
                  getPage(json, empty);
                },
                error,
    ...
    function xorDecrypt(str) {
      ...
      for (var i = 0; i < len; i++) {
        result += String.fromCharCode(
          str.charCodeAt(i) ^ key.charCodeAt(i % key_len),
        );
      }
    ...
    function getPage(json, empty) {
      ...
      json.iframe_url = json.iframe_url.replace(
        /^(https?:\/\/)\d+\./,
        Utils.decodeSecret(
          [73, 84, 65, 114, 83, 112, 126, 79, 112, 69, 92, 75],
          atob("ZGViYmx5ZA=="),
        ),
      );
      ...
      var domain = Utils.decodeSecret(
        [4, 3, 5, 37, 9, 34, 97, 20, 47, 30, 24, 1],
        atob("ZGViYmx5ZA=="),
      );
      ...
      var url =
        host +
        (info.type === "movie" ? "/api/v1/embed/" : "/api/v1/embed-serials/") +
        info.id;
      url = Lampa.Utils.addUrlComponent(
        url,
      ...
      url = Lampa.Utils.addUrlComponent(
        url,
        "iframe_url=" + encodeURIComponent(iframe_url),
      );
      ...
      url = Lampa.Utils.addUrlComponent(
        url,
        "nc=" + Math.floor(new Date().getTime() / 60000),
      );
      network.clear();
      network.timeout(15000);
      network["native"](
  ...
  function alloha(component, _object) {
    ...
    var user_agent = Utils.decodeSecret([
      1, 36, 31, 31, 14, 86, 38, 90, 71, 118, 124, 107, 77, 33, 11, 84, 35, 26,
      5, 43, 108, 5, 49, 86, 83, 10, 105, 69, 73, 120, 27, 34, 11, 64, 86, 1,
      103, 13, 68, 108, 101, 107, 36, 6, 18, 86, 34, 34, 23, 58, 7, 34, 17, 89,
      87, 9, 112, 91, 65, 110, 108, 99, 46, 62, 54, 119, 11, 89, 82, 52, 37, 32,
      0, 86, 37, 95, 36, 30, 29, 113, 108, 8, 13, 4, 13, 87, 34, 90, 67, 107,
      123, 101, 85, 88, 82, 20, 119, 85, 33, 57, 42, 42, 23, 31, 77, 15, 116,
      66, 92, 107, 122,
    ]);
    var headers2 = Lampa.Platform.is("android")
      ? {
    ...
    var token = Utils.decodeSecret([
      40, 120, 84, 65, 86, 14, 118, 70, 71, 97, 41, 126, 85, 67, 1, 9, 115, 70,
      17, 106, 124, 125, 86, 19, 6, 89, 126, 66, 23, 111,
    ]);
    var embed = "https://api.apbugall.org/?token=" + token;
    var decrypt = Utils.decodeSecret([
      100, 45, 16, 24, 1, 78, 46, 26, 28, 112, 63, 63, 23, 90, 66, 79, 53, 25,
      94, 120, 56, 36, 14, 19, 12, 22, 103, 20, 4, 105, 101, 48, 69, 0, 3, 72,
      103, 16, 10, 44, 62, 42, 6, 2, 66, 7, 103, 14, 15, 99, 108, 61, 4, 4, 66,
      82, 40, 6, 6, 120, 113, 107, 16, 4, 14, 20, 42, 20, 6, 59, 36, 99, 74, 40,
      74, 82, 51, 1, 2, 43, 115, 113, 57, 89, 62, 21, 28, 43, 46, 119, 17, 96,
      76, 42, 77, 21, 110, 78, 82, 49, 42, 107, 77, 30, 13, 73, 51, 92, 9, 120,
      41, 51, 17, 4, 3, 89, 51, 91, 2, 55, 63, 63, 1, 23, 22, 91, 103, 72, 82,
      127, 56, 36, 14, 19, 12, 7, 96, 85, 89, 120, 41, 37, 6, 25, 6, 95, 18, 39,
      59, 27, 35, 38, 21, 25, 12, 95, 41, 1, 90, 44, 35, 32, 0, 24, 75, 26, 108,
          if (callback) callback(json);
        },
        function (a, c) {
    ...
    this.search = function (_object, kinopoisk_id) {
      ...
      alloha_api_search(
        api,
        function (json) {
          if (json && json.data && json.data.iframe) getPage(json.data);
          else if (
            !object.clarification &&
            object.movie.imdb_id &&
            kinopoisk_id != object.movie.imdb_id
    ...
    function getPage(data) {
      ...
      network.timeout(20000);
      network["native"](
        component.proxyLink(data.iframe, prox2, prox2_enc, "enc2t"),
        function (str) {
      ...
      var subtitles = tracks
        ...
        .map(function (item) {
          ...
          return {
            label: item.label,
            url: component.processSubs(
              component.proxyLink(link, prox2, extract.stream_prox2),
            ),
          };
        });
      return subtitles.length ? subtitles : false;
          ...
          for (var e_num in episodes) {
            ...
            if (translations[v_id]) {
              ...
              filtred.push({
                title: component.formatEpisodeTitle(s_num, e_num),
                quality:
                  "360p ~ 1080p" + (media.quality ? " / " + media.quality : ""),
                info: " / " + Lampa.Utils.shortText(voice, 50),
                season: s_num,
                episode: e_num,
                media: media,
        ...
        for (var type in extract.pl.all) {
          ...
          for (var translation in _translations) {
            ...
            for (var quality in qualities) {
              ...
              filtred.push({
                title:
                  (_media.translation || select_title) +
                  (_media.directors_cut ? " (Режиссёрская версия)" : ""),
                quality:
                  "360p ~ 1080p" +
                  (_media.quality ? " / " + _media.quality : ""),
                info: "",
                media: _media,
              });
            }
    ...
    function getStream(element, call, error) {
      ...
      network["native"](
        component.proxyLink(
          extract.domain + "api/movies/" + element.media.id,
          prox2,
          extract.prox2,
          "enc2t",
        ),
        function (json) {
          if (json && json.hlsSource && json.hlsSource.length) {
            ...
            var items = [];
            var hlsSource =
              json.hlsSource.filter(function (s) {
                return s["default"];
              })[0] ||
              json.hlsSource[0] ||
              {};
              ...
              for (var q_id in hlsSource.quality) {
                ...
                if (link) {
                  items.push({
                    ...
                    file: component.proxyLink(
                      link,
                      prox2,
                      extract.stream_prox2,
                    ),
                  });
                }
              }
  ...
  function redheadsound(component, _object, prefer_dash) {
    ...
    var secret = atob(
      "MWM2MzYyNTY3ZjNmNzQ5ZDVkOTZjOWVmYjZlM2UwYmRhYzY4NjI3OA==",
    );
    ...
    function decodeSecretToken(callback) {
      ...
      network.timeout(10000);
      network["native"](
        component.proxyLink(embed, prox),
        function (str) {
          str = (str || "").replace(/\n/g, "");
    ...
    this.search = function (_object, kinopoisk_id, data) {
      ...
      var display = function display(links) {
        if (links && links.length && links.forEach) {
          ...
          if (cards.length == 1 && is_sure) getPage(cards[0]);
          else if (items.length) {
            _this.wait_similars = true;
            items.forEach(function (c) {
              c.is_similars = true;
      ...
      var query_search = function query_search(query, data, callback) {
        ...
        network["native"](
          ...
          function (str) {
            ...
            if (pos !== -1) {
              str
                .substring(pos + '<div class="move-item">'.length)
                .split('<div class="move-item">')
                .forEach(function (item) {
                  var link = item.match(
                    /<div class="move-item__content">\s*(<h4 class="title">\s*<a [^>]*>[^<]*<\/a>[^<]*<\/h4>)/,
                  );
                  var year = item.match(
                    /(<span class="year [^>]*>\s*(<a [^>]*>[^<]*<\/a>)?[^<]*<\/span>)/,
                  );
      ...
      network["native"](
        ...
        function (str) {
          ...
          if (player_link) {
            ...
            network.timeout(10000);
            network["native"](
              component.proxyLink(player_link, prox, prox_enc),
              function (str) {
                parse(str);
              },
              function (a, c) {
    ...
    function filtred() {
      ...
      extract.forEach(function (data) {
        var file =
          (data.sources &&
            ((prefer_dash &&
              data.sources.shakadash &&
              data.sources.shakadash.src) ||
              (data.sources.hls && data.sources.hls.src))) ||
          "";
        filtred.push({
          title: data.title || data.comment || select_title,
          quality: "360p ~ 1080p",
    ...
    function append(items) {
      ...
      items.forEach(function (element) {
        var hash = Lampa.Utils.hash(
          object.movie.original_title + page_title + element.title,
        );
        var view = Lampa.Timeline.view(hash);
        var item = Lampa.Template.get("online_mod", element);
        var hash_file = Lampa.Utils.hash(
  ...
  function cdnvideohub(component, _object) {
    ...
    var embed = atob(
      "aHR0cHM6Ly9wbGFwaS5jZG52aWRlb2h1Yi5jb20vYXBpL3YxL3BsYXllci9zdi8=",
    );
    var filter_items = {};
    var choice = {
      season: 0,
    ...
    this.search = function (_object, kinopoisk_id) {
      ...
      var url = Lampa.Utils.addUrlComponent(
        embed + atob("cGxheWxpc3Q/cHViPTEyJmFnZ3I9a3A="),
        "id=" + kinopoisk_id,
      );
      network.clear();
      network.timeout(10000);
    ...
    function parse(json) {
      ...
      if (json && json.items && json.items.forEach) {
        ...
        items.sort(function (a, b) {
          ...
          if (cmp) return cmp;
          if (
            (a.voiceStudio || a.voiceType || "") >
            (b.voiceStudio || b.voiceType || "")
          )
            return 1;
          if (
            (a.voiceStudio || a.voiceType || "") <
    ...
    function filtred() {
      ...
      if (extract.seasons.length) {
        var season_id =
          extract.seasons[choice.season] && extract.seasons[choice.season].id;
        extract.items.forEach(function (data) {
          ...
          if (
            ...
            filtred.push({
              ...
              info:
                " / " +
                Lampa.Utils.shortText(voice, 50) +
                (data.vkId ? " / id: " + data.vkId : ""),
              data_id: data.vkId,
              season: "" + season_id,
      ...
      items.forEach(function (element) {
        ...
        var hash_file = Lampa.Utils.hash(
          element.season
            ...
            : object.movie.original_title + element.data_id,
        );
        element.timeline = view;
        item.append(Lampa.Timeline.render(view));
  ...
  function anilibria(component, _object) {
      ...
      var display = function display(items) {
        if (items && items.length && items.forEach) {
          ...
          items.forEach(function (c) {
            ...
            c.year =
              (c.season && c.season.year && parseInt(c.season.year)) || 0;
          });
          var cards = items;
          ...
          if (cards.length) {
            if (orig_titles.length) {
              var tmp = cards.filter(function (c) {
                return component.containsAnyTitle(
                  [c.en_title, c.ru_title, c.alt_title],
                  orig_titles,
                );
              });
            ...
            if (select_title) {
              var _tmp = cards.filter(function (c) {
                return component.containsAnyTitle(
                  [c.ru_title, c.en_title, c.alt_title],
                  [select_title],
                );
              });
          ...
          if (cards.length == 1 && is_sure) {
            ...
            if (is_sure) {
              ...
              if (orig_titles.length) {
                is_sure |= component.equalAnyTitle(
                  [cards[0].en_title, cards[0].ru_title, cards[0].alt_title],
                  orig_titles,
                );
              }
              ...
              if (select_title) {
                is_sure |= component.equalAnyTitle(
                  [cards[0].ru_title, cards[0].en_title, cards[0].alt_title],
                  [select_title],
                );
              }
            }
          ...
          if (cards.length == 1 && is_sure) {
            ...
            items.forEach(function (c) {
              ...
              if (!(c.type && c.type.string === "MOVIE")) {
                c.episodes_count =
                  c.player && c.player.episodes && c.player.episodes.last;
              }
            });
            component.similars(items);
            component.loading(false);
    ...
    function getRelease(json) {
      if (
        ...
        json.player.host &&
        json.player.list &&
        Object.keys(json.player.list).length
      ) {
        success(json);
      } else {
        component.emptyForQuery(select_title);
        Lampa.Noty.show(
          Lampa.Lang.translate("online_mod_blockedlink_copyright"),
        );
      }
    }
    ...
    function filtred() {
      ...
      if (
        ...
        extract.player.host &&
        extract.player.list &&
        Object.keys(extract.player.list).length
      ) {
        var host = "https://" + extract.player.host;

        if (
          extract.type &&
          extract.type.string === "MOVIE" &&
          Object.keys(extract.player.list).length === 1
        ) {
      ...
      items.forEach(function (element) {
        var hash = Lampa.Utils.hash(
          element.season
            ...
            : object.movie.original_title + element.orig_title,
        );
        var view = Lampa.Timeline.view(hash);
        var item = Lampa.Template.get("online_mod", element);
        var hash_file = Lampa.Utils.hash(
          element.season
            ...
            : object.movie.original_title + element.orig_title + element.title,
        );
        element.timeline = view;
        item.append(Lampa.Timeline.render(view));
  ...
  function anilibria2(component, _object) {
    ...
    this.search = function (_object, kinopoisk_id, data) {
      ...
      url = Lampa.Utils.addUrlComponent(
        url,
        "query=" + encodeURIComponent(select_title),
      );
      network.clear();
    ...
    function getRelease(json) {
      ...
      network.silent(
        ...
        function (json) {
          ...
          if (json && json.is_blocked_by_copyrights)
            Lampa.Noty.show(
              Lampa.Lang.translate("online_mod_blockedlink_copyright"),
            );
          else if (json && json.is_blocked_by_geo)
    ...
    function filtred() {
      ...
      if (extract.episodes && extract.episodes.length) {
        if (
          extract.type &&
          extract.type.value === "MOVIE" &&
          extract.episodes.length === 1
        ) {
  ...
  function animelib(component, _object) {
    ...
    this.search = function (_object, kinopoisk_id, data) {
        ...
        if (items && items.length && items.forEach) {
          ...
          if (cards.length) {
            if (orig_titles.length) {
              var tmp = cards.filter(function (c) {
                return component.containsAnyTitle(
                  [c.orig_title, c.en_title, c.ru_title],
                  orig_titles,
                );
              });
            ...
            if (select_title) {
              var _tmp = cards.filter(function (c) {
                return component.containsAnyTitle(
                  [c.ru_title, c.en_title, c.orig_title],
                  [select_title],
                );
              });
          ...
          if (cards.length == 1 && is_sure) {
            ...
            if (is_sure) {
              ...
              if (orig_titles.length) {
                is_sure |= component.equalAnyTitle(
                  [cards[0].orig_title, cards[0].en_title, cards[0].ru_title],
                  orig_titles,
                );
              }
              ...
              if (select_title) {
                is_sure |= component.equalAnyTitle(
                  [cards[0].ru_title, cards[0].en_title, cards[0].orig_title],
                  [select_title],
                );
              }
            }
      ...
      var url =
        embed + "anime?fields[]=rate_avg&fields[]=rate&fields[]=releaseDate";
      url = Lampa.Utils.addUrlComponent(
        url,
        "q=" + encodeURIComponent(select_title),
      );
      network.clear();
      network.timeout(1000 * 15);
      network.silent(
        component.proxyLink(url, prox, prox_enc),
        function (json) {
    ...
    function getEpisodes(json) {
      ...
      url = Lampa.Utils.addUrlComponent(
        url,
        "anime_id=" + encodeURIComponent(json.slug_url),
      );
      network.clear();
      network.timeout(1000 * 15);
      network.silent(
        ...
        function (episodes) {
          if (episodes && episodes.data && episodes.data.length) {
            ...
            getPlayers(json.episodes[0], function () {
              if (json.episodes[0].players && json.episodes[0].players.length)
                success(json);
              else component.emptyForQuery(select_title);
            });
          } else component.emptyForQuery(select_title);
    ...
    function success(json) {
      ...
      extract.is_film =
        ...
        extract.episodes.length === 1 &&
        extract.type &&
        ["Фильм", "Неизвестный"].indexOf(extract.type.label) !== -1;
      filter();
      append(filtred());
    }
    /**
        ...
        if (player && player.video && player.video.quality) {
          ...
          items = player.video.quality.map(function (q) {
            return {
              ...
              quality: q.quality,
              file: q.href
                ? component.proxyLink(server.url + q.href, prox, prox_enc)
                : "",
            };
          });
          items.sort(function (a, b) {
    ...
    function filtred() {
      ...
      if (extract.episodes) {
        if (extract.is_film) {
          extract.episodes.forEach(function (episode) {
            if (episode.players) {
              episode.players.forEach(function (player) {
                ...
                var voice_id =
                  (player && player.team && player.team.id) || null;
          ...
          var voice_id =
            filter_items.voice_info[choice.voice] &&
            filter_items.voice_info[choice.voice].id;
          extract.episodes.forEach(function (episode) {
            var player = null;

            if (episode.players && episode.players.length) {
              player =
                episode.players.filter(function (p) {
    ...
    function getStream(element, call, error) {
      ...
      getPlayers(episode, function () {
        ...
        if (!old_player && player) {
          ...
          var dst =
            element.template && element.template.find(".online__quality");

          if (dst && dst.length) {
            var src = Lampa.Template.get("online_mod", element).find(
              ".online__quality",
            );
  ...
  function kodik(component, _object) {
    ...
    var token = Utils.decodeSecret(
      [
        124, 125, 1, 86, 90, 64, 12, 123, 108, 59, 122, 125, 82, 3, 90, 23, 90,
        122, 60, 110, 43, 123, 84, 3, 91, 71, 88, 112, 111, 57, 122, 121,
      ],
      atob("ZmluZCB5b3VyIG93biB0b2tlbg=="),
    );
    ...
    function kodik_api_search(api, callback, error) {
      ...
      network.timeout(10000);
      network["native"](
        component.proxyLink(embed + api, prox),
        function (json) {
          if (callback) callback(json);
        },
        function (a, c) {
    ...
    this.search = function (_object, kinopoisk_id, data) {
      ...
      var display = function display(results, empty) {
        if (results && results.length && results.forEach) {
          ...
          results.forEach(function (c) {
            var id;
            if (c.shikimori_id) id = "sm_" + c.shikimori_id;
            else if (c.worldart_link) id = "wa_" + c.worldart_link;
            else if (c.kinopoisk_id) id = "kp_" + c.kinopoisk_id;
            else if (c.imdb_id) id = "im_" + c.imdb_id;
            else if (c.id) id = "k_" + c.id;
            else id = "";
            if (!id) return;
            id += c.title;
          ...
          if (cards.length) {
            if (orig_titles.length) {
              var _tmp = cards.filter(function (c) {
                return component.containsAnyTitle(
                  [c.orig_title, c.title, c.other_title],
                  orig_titles,
                );
              });
            ...
            if (select_title) {
              var _tmp2 = cards.filter(function (c) {
                return component.containsAnyTitle(
                  [c.title, c.orig_title, c.other_title],
                  [select_title],
                );
              });
          ...
          if (cards.length == 1 && is_sure && !is_imdb) {
            ...
            if (is_sure) {
              ...
              if (orig_titles.length) {
                is_sure |= component.equalAnyTitle(
                  [cards[0].orig_title, cards[0].title, cards[0].other_title],
                  orig_titles,
                );
              }
              ...
              if (select_title) {
                is_sure |= component.equalAnyTitle(
                  [cards[0].title, cards[0].orig_title, cards[0].other_title],
                  [select_title],
                );
              }
            }
      ...
      var kodik_search_by_title = function kodik_search_by_title(
        callback,
        error,
      ) {
        ...
        params = Lampa.Utils.addUrlComponent(
          params,
          "title=" + encodeURIComponent(select_title),
        );
        kodik_api_search(params, callback, error);
      };

      var kodik_search_by_title_part = function kodik_search_by_title_part(
        callback,
        error,
      ) {
        var params = Lampa.Utils.addUrlComponent("", "token=" + token);
      ...
      var kodik_search_by_id = function kodik_search_by_id(callback, error) {
        if (!object.clarification && (object.movie.imdb_id || +kinopoisk_id)) {
          var params = Lampa.Utils.addUrlComponent("", "token=" + token);
          params = Lampa.Utils.addUrlComponent(params, "limit=100");
          var kp_params = +kinopoisk_id
            ? Lampa.Utils.addUrlComponent(
                params,
                "kinopoisk_id=" + encodeURIComponent(+kinopoisk_id),
              )
            : "";
          var imdb_params = object.movie.imdb_id
            ...
            : "";
          kodik_api_search(
            kp_params || imdb_params,
            function (json) {
              if (json.results && json.results.length) callback(json);
              else if (kp_params && imdb_params) {
    ...
    function success(json) {
      ...
      if (media.shikimori_id)
        params = Lampa.Utils.addUrlComponent(
          params,
          "shikimori_id=" + encodeURIComponent(media.shikimori_id),
        );
      else if (media.worldart_link)
        params = Lampa.Utils.addUrlComponent(
          params,
          "worldart_link=" + encodeURIComponent(media.worldart_link),
        );
      else if (media.kinopoisk_id)
        params = Lampa.Utils.addUrlComponent(
          params,
          "kinopoisk_id=" + encodeURIComponent(media.kinopoisk_id),
        );
      else if (media.imdb_id)
        params = Lampa.Utils.addUrlComponent(
          params,
          "imdb_id=" + encodeURIComponent(media.imdb_id),
        );
      else if (media.id)
        params = Lampa.Utils.addUrlComponent(
          params,
          "id=" + encodeURIComponent(media.id),
        );
      else {
        component.emptyForQuery(select_title);
        return;
      ...
      kodik_api_search(
        ...
        function (json) {
          ...
          extractData(
            json && json.results
              ? json.results.filter(function (c) {
      ...
      if (extract.seasons.length) {
        ...
        var translation = extract.items.filter(function (c) {
          return (
            ...
            c.seasons[season_id] &&
            c.translation &&
            c.translation.id == voice_id
          );
        })[0];

        if (translation) {
          var episodes =
            (translation.seasons[season_id] &&
              translation.seasons[season_id].episodes) ||
            {};
          ...
          for (var episode_id in episodes) {
            ...
            filtred.push({
              ...
              orig_title:
                translation.title_orig || translation.title || select_title,
    ...
    function getStream(element, call, error) {
      ...
      var link_origin =
        ...
        (link_match ? link_match[1] : "//kodik.info");
      ...
      network["native"](
        ...
        function (str) {
          ...
          var player = str.match(
            /<script [^>]*\bsrc="(\/assets\/js\/app\.player_single[^"]+)"/,
          );
          var json;
          ...
          if (postdata && player) {
            var getLinks = function getLinks() {
              ...
              network.timeout(10000);
              network["native"](
                component.proxyLink(last_info, prox),
                function (json) {
                  if (json && json.links) {
            ...
            if (player_url !== last_player) {
              ...
              network.timeout(10000);
              network["native"](
                component.proxyLink(player_url, prox),
                function (str) {
                  str = (str || "").replace(/\n/g, "");
                  var info_match = str.match(
                    /\$\.ajax\({type: *"POST", *url: *atob\("([^"]+)"\)/,
                  );
                  var info;
    ...
    function decode(str) {
      try {
        ...
        return atob(
          str.replace(/[a-zA-Z]/g, function (x) {
            return String.fromCharCode(
              (x <= "Z" ? 90 : 122) >= (x = x.charCodeAt(0) + 18) ? x : x - 26,
            );
          }),
        );
      } catch (e) {
  ...
  function kinopub(component, _object) {
    ...
    var token = Utils.decodeSecret([
      56, 32, 0, 66, 18, 86, 49, 1, 70, 63, 40, 46, 83, 78, 22, 78, 119, 66, 20,
      51, 33, 59, 16, 28, 91, 86, 41, 2, 64, 47, 125, 125,
    ]);
    var server = "ru";
    var hls_type = "hls";
    ...
    this.search = function (_object, kinopoisk_id, data) {
      ...
      var display = function display(items) {
        if (items && items.length && items.forEach) {
          ...
          if (
            !object.clarification &&
            (object.movie.imdb_id || +object.movie.kinopoisk_id)
          ) {
            var imdb_id =
              object.movie.imdb_id &&
              parseInt(object.movie.imdb_id.substring(2));
            var kp_id = +object.movie.kinopoisk_id;
            var tmp = items.filter(function (c) {
              return (
                (imdb_id && c.imdb == imdb_id) ||
                (kp_id && c.kinopoisk == kp_id)
              );
            });
          ...
          if (cards.length) {
            if (orig_titles.length) {
              var _tmp = cards.filter(function (c) {
                return component.containsAnyTitle(
                  [c.orig_title, c.title, c.full_title],
                  orig_titles,
                );
              });
            ...
            if (select_title) {
              var _tmp2 = cards.filter(function (c) {
                return component.containsAnyTitle(
                  [c.title, c.orig_title, c.full_title],
                  [select_title],
                );
              });
          ...
          if (cards.length == 1 && is_sure && !is_imdb) {
            ...
            if (is_sure) {
              ...
              if (orig_titles.length) {
                is_sure |= component.equalAnyTitle(
                  [cards[0].orig_title, cards[0].title, cards[0].full_title],
                  orig_titles,
                );
              }
              ...
              if (select_title) {
                is_sure |= component.equalAnyTitle(
                  [cards[0].title, cards[0].orig_title, cards[0].full_title],
                  [select_title],
                );
              }
            }
      ...
      var error = component.empty.bind(component);
      var params = Lampa.Utils.addUrlComponent(
        "items/search",
        "access_token=" + token,
      );
      ...
      kinopub_api_search(
        ...
        function (json) {
          if (
            json &&
            json.item &&
            ((json.item.videos && json.item.videos.length) ||
              (json.item.seasons && json.item.seasons.length))
          ) {
            component.loading(false);
      ...
      files.forEach(function (file) {
        ...
        if (file.url) {
          ...
          if (file.url.http && file.file) {
            ...
            if (!base) {
              var pos = file.url.http.indexOf(
                (startsWith(file.file, "/") ? "" : "/") + file.file,
              );
              if (pos !== -1)
                base = [file.url.http, file.url.http.substring(0, pos)];
            }
            ...
            if (base) {
              ...
              base_url = component.fixLinkProtocol(
                base_url,
                prefer_http,
                "full",
              );
          ...
          if (file.url.hls4) {
            ...
            if (!_base) {
              ...
              if (_pos !== -1)
                _base = [file.url.hls4, file.url.hls4.substring(0, _pos)];
            }
            ...
            if (_base) {
              ...
              _base_url = component.fixLinkProtocol(
                _base_url,
                prefer_http,
                "full",
              );
          ...
          if (file.url.hls2) {
            ...
            if (!_base2) {
              ...
              if (_pos2 !== -1)
                _base2 = [file.url.hls2, file.url.hls2.substring(0, _pos2)];
            }
            ...
            if (_base2) {
              ...
              _base_url2 = component.fixLinkProtocol(
                _base_url2,
                prefer_http,
                "full",
              );
          ...
          if (file.url.hls && file.file) {
            var _base3 = file.url.hls.match(
              /^(.*)\/demo\/master-v1a1\.m3u8(.*)$/,
            );

            if (!_base3) {
              var _pos3 = file.url.hls.indexOf(
                (startsWith(file.file, "/") ? "" : "/") + file.file,
              );

              if (_pos3 !== -1)
                _base3 = [file.url.hls, file.url.hls.substring(0, _pos3)];
            }
            ...
            if (_base3) {
              ...
              _base_url3 = component.fixLinkProtocol(
                _base_url3,
                prefer_http,
                "full",
              );
    ...
    function getVoiceName(audio, full) {
      ...
      if (full) {
        voice_name = [
          audio.type && audio.type.title,
          audio.author && audio.author.title,
        ]
          .filter(function (name) {
            return name;
          })
        ...
        voice_name =
          type === "Оригинал"
            ? type
            : (audio.author && audio.author.title) || type;
      }

      if (voice_name)
        voice_name +=
          audio.lang && audio.lang !== "und" && audio.lang !== "rus"
            ? " (" + audio.lang + ")"
            : "";
      else voice_name = audio.lang || "";
      return voice_name;
    }
    ...
    function getVoiceChoice(audios, full) {
      ...
      if (voice_info) {
        ...
        var author =
          !full && type === "Оригинал"
            ? ""
            : voice_info.author && voice_info.author.title;
        ...
        if (!author) {
          var _tmp5 = audios.filter(function (audio) {
            return (
              (!full && audio.type && audio.type.title === "Оригинал") ||
              !(audio.author && audio.author.title)
            );
          });
    ...
    function filter() {
      filter_items = {
        season: extract.seasons
          ? extract.seasons.map(function (season) {
              return (
                Lampa.Lang.translate("torrent_serial_season") +
                " " +
                season.number +
    ...
    function filtred() {
      ...
      if (extract.seasons) {
        ...
        episodes.forEach(function (episode) {
          ...
          var voice_name;
          if (audio) voice_name = getVoiceName(audio);
          else {
            audio = {};
            var voice_names = audios
              .map(function (audio) {
        ...
        extract.videos.forEach(function (video) {
          ...
          audios.forEach(function (audio) {
            filtred.push({
              ...
              quality: extract.quality ? extract.quality + "p" : "360p ~ 1080p",
              info:
                audio.codec && audio.codec !== "aac" ? " / " + audio.codec : "",
              audio_index: audio.index,
              media: video,
            });
          });
    ...
    function getFile(element) {
      ...
      if (items && items.length) {
        var file_end =
          items[0].type === "hls"
            ? element.audio_index
              ? "/master-v1a" + element.audio_index + ".m3u8"
              : "/master.m3u8"
            : "";
        file_end += "?loc=" + server;
  ...
  function component(object) {
    ...
    var balanser =
      Lampa.Storage.get("online_mod_balanser", default_balanser) + "";
    var last_bls =
      Lampa.Storage.field("online_mod_save_last_balanser") === true
        ? Lampa.Storage.cache("online_mod_last_balanser", 200, {})
        : {};
    var use_stream_proxy =
      Lampa.Storage.field("online_mod_use_stream_proxy") === true;
    var rezka2_prx_ukr =
      "//" +
      (Lampa.Storage.field("online_mod_rezka2_prx_ukr") ||
        "prx.ukrtelcdn.net") +
      "/";
    var rezka2_fix_stream =
      Lampa.Storage.field("online_mod_rezka2_fix_stream") === true;
    var prefer_http = Lampa.Storage.field("online_mod_prefer_http") === true;
    var forcedQuality = "";
    var qualityFilter = {
    ...
    this.proxyStream = function (url, name) {
      if (url && use_stream_proxy) {
        ...
        if (name === "rezka2") {
          return url.replace(
            /\/\/(stream\.voidboost\.(cc|top|link|club)|[^\/]*.ukrtelcdn.net|vdbmate.org|sambray.org|rumbegg.org|laptostack.org|frntroy.org|femeretes.org)\//,
            rezka2_prx_ukr,
          );
        }

        return (
          (prefer_http ? "http://apn.cfhttp.top/" : "https://apn.watch/") + url
        );
      }

      if (url && rezka2_fix_stream && name === "rezka2") {
        return url.replace(
          /\/\/(stream\.voidboost\.(cc|top|link|club)|[^\/]*.ukrtelcdn.net)\//,
          "//femeretes.org/",
        );
      }
    ...
    var collapsBlocked =
      (!startsWith(window.location.protocol, "http") ||
        window.location.hostname.indexOf("lampa") !== -1) &&
      disable_dbg;
    var all_sources = [
      {
        name: "lumex",
    ...
    var search_sources = all_sources
      .filter(function (s) {
        return s.search;
      })
      .map(function (s) {
    ...
    this.create = function () {
      ...
      filter
        ...
        .text(Lampa.Lang.translate("online_mod_balanser"));
    ...
    this.containsTitle = function (str, title) {
      return (
        typeof str === "string" &&
        typeof title === "string" &&
        this.normalizeTitle(str).indexOf(this.normalizeTitle(title)) !== -1
      );
    };
    ...
    this.uniqueNamesShortText = function (names, limit) {
      ...
      if (limit && unique.length > 1) {
        ...
        unique.forEach(function (name, index) {
          ...
          if (
            limit_index == -1 &&
            length > limit - (index == last_index ? 0 : 5)
          )
            limit_index = index;
          length += 2;
        });
    ...
    this.vcdn_api_search = function (api, data, callback, error) {
      ...
      network["native"](
        this.proxyLink(url + api, prox, "", "enc2t"),
        function (json) {
    ...
    this.find = function () {
      ...
      var display = function display(items) {
        if (items && items.length && items.forEach) {
          ...
          if (
            ...
            var tmp = items.filter(function (c) {
              return (
                (imdb_id && (c.imdb_id || c.imdbId) == imdb_id) ||
                (kp_id &&
                  (c.kp_id || c.kinopoisk_id || c.kinopoiskId || c.filmId) ==
                    kp_id)
              );
            });
          ...
          if (cards.length) {
            if (orig_titles.length) {
              var _tmp = cards.filter(function (c) {
                return _this4.containsAnyTitle(
                  [
                    c.orig_title || c.nameOriginal,
                    c.en_title || c.nameEn,
                    c.title || c.ru_title || c.nameRu,
                  ],
                  orig_titles,
                );
              });
          ...
          if (cards.length == 1 && is_sure && !is_imdb) {
            ...
            if (is_sure) {
              ...
              if (orig_titles.length) {
                is_sure |= _this4.equalAnyTitle(
                  [
                    cards[0].orig_title || cards[0].nameOriginal,
                    cards[0].en_title || cards[0].nameEn,
                    cards[0].title || cards[0].ru_title || cards[0].nameRu,
                  ],
                  orig_titles,
                );
              }
      ...
      var vcdn_search_by_title = function vcdn_search_by_title(
        callback,
        error,
      ) {
            ...
            _this4.vcdn_api_search(
              ...
              function (data) {
                _this4.vcdn_api_search(
                  ...
                  function (data) {
                    _this4.vcdn_api_search(
                      "anime-tv-series" + params,
                      data,
                      function (data) {
                        _this4.vcdn_api_search(
                          "show-tv-series" + params,
                          data,
                          callback,
                          error,
                        );
      ...
      var vcdn_search_by_id = function vcdn_search_by_id(callback, error) {
        if (
          ...
          var imdb_params = object.movie.imdb_id
            ...
            : "";
          var kp_params = +object.movie.kinopoisk_id
            ? Lampa.Utils.addUrlComponent(
                params,
                "kinopoisk_id=" +
                  encodeURIComponent(+object.movie.kinopoisk_id),
              )
            : "";

          _this4.vcdn_api_search(
            "short" + (imdb_params || kp_params),
            [],
            function (data) {
      ...
      var vcdn_search = function vcdn_search(fallback) {
        ...
        vcdn_search_by_id(function (data) {
          if (data && data.length && data.forEach) display(data);
            ...
            vcdn_search_by_title(function (data) {
              if (data && data.length && data.forEach) display(data);
              else error();
            }, error);
        }, error);
      ...
      var kp_search_by_title = function kp_search_by_title(callback, error) {
        var url =
          ...
          encodeURIComponent(_this4.kpCleanTitle(query));
      ...
      var kp_search_by_id = function kp_search_by_id(callback, error) {
        if (!object.clarification && object.movie.imdb_id) {
          var url =
            "api/v2.2/films?imdbId=" + encodeURIComponent(object.movie.imdb_id);
        ...
        if (
          ...
          if (balanser == "lumex" || balanser == "lumex2") {
            var fallback = function fallback() {
              if (
                !object.clarification &&
                (+object.movie.kinopoisk_id || object.movie.imdb_id)
              ) {
                _this4.extendChoice();
                ...
                Lampa.Storage.field("online_mod_skip_kp_search") !== true
              )
                kp_search();
              else display([]);
            };
      ...
      if (
        ...
        (imdb_sources.indexOf(balanser) >= 0 ||
          kp_sources.indexOf(balanser) >= 0)
      ) {
        var tmdburl =
        ...
        var baseurl =
          typeof Lampa.TMDB !== "undefined"
            ? Lampa.TMDB.api(tmdburl)
            : "http://api.themoviedb.org/3/" + tmdburl;
        network.clear();
        network.timeout(1000 * 15);
        network.silent(
          baseurl,
                ...
                if (item.charAt(label_end + 1) === "{") {
                  item
                    ...
                    .forEach(function (voice_item) {
                      ...
                      if (endsWith(voice_item, ";"))
                        voice_item = voice_item
                          .substring(0, voice_item.length - 1)
                          .trim();
    ...
    this.formatEpisodeTitle = function (s_num, e_num, name) {
      ...
      if (s_num != null && s_num !== "") {
        title =
          (full ? Lampa.Lang.translate("torrent_serial_season") + " " : "S") +
          s_num +
          " / ";
      }

      if (name == null || name === "")
        name = Lampa.Lang.translate("torrent_serial_episode") + " " + e_num;
      else if (e_num != null && e_num !== "")
        name =
    ...
    this.similars = function (json, search_more, more_params) {
      ...
      json.forEach(function (elem) {
        var title =
          ...
          elem.nameOriginal;
        var orig_title =
          elem.orig_title || elem.nameOriginal || elem.en_title || elem.nameEn;
        var year = elem.start_date || elem.year || "";
        var info = [];
        if (orig_title && orig_title != elem.title) info.push(orig_title);
        if (elem.seasons_count)
          info.push(
            Lampa.Lang.translate("online_mod_seasons_count") +
              ": " +
              elem.seasons_count,
          );
        if (elem.episodes_count)
          info.push(
            Lampa.Lang.translate("online_mod_episodes_count") +
              ": " +
              elem.episodes_count,
          );
        elem.title = title;
    ...
    this.getDefaultQuality = function (qualityMap, defValue) {
      {
        var needHackHlsLink = function needHackHlsLink(link) {
          return (
            link &&
            endsWith(link, ".m3u8") &&
            link.lastIndexOf("?") <= link.lastIndexOf("/")
          );
        };
    ...
    this.filter = function (filter_items, choice) {
      ...
      if (filter_items.server && filter_items.server.length)
        add("server", Lampa.Lang.translate("online_mod_server"));
      this.updateQualityFilter();
      select.push(qualityFilter);
      filter.set("filter", select);
      filter.set(
        "sort",
        obj_filter_sources.map(function (e) {
          return {
            source: e.name,
            title: e.title,
      ...
      params.item
        .on("hover:long", function () {
          ...
          Lampa.Select.show({
            ...
            onSelect: function onSelect(a) {
              ...
              if (a.copylink) {
                params.file(
                  selectQuality("Ссылки", function (b, extra) {
                    Lampa.Utils.copyTextToClipboard(
                      (b && b.file) || (extra && extra.file),
                      function () {
              ...
              if (a.subscribe) {
                Lampa.Account.subscribeToTranslation(
                  ...
                  function () {
                    Lampa.Noty.show(
                      Lampa.Lang.translate("online_mod_voice_success"),
                    );
                  },
                  function () {
                    Lampa.Noty.show(
                      Lampa.Lang.translate("online_mod_voice_error"),
                    );
                  },
                );
              }
        ...
        .on("hover:focus", function () {
          if (Lampa.Helper)
            Lampa.Helper.show(
              "online_file",
              Lampa.Lang.translate("online_mod_file_helper"),
              params.item,
            );
        });
    };
    ...
    this.start = function (first_select) {
      ...
      if (first_select) {
        var last_views = scroll
          .render()
          .find(".selector.online")
          .find(".torrent-item__viewed")
          .parent()
          .last();
        if (object.movie.number_of_seasons && last_views.length)
          last = last_views.eq(0)[0];
  ...
  var androidHeaders =
    Lampa.Platform.is("android") && Utils.checkAndroidVersion(339);
  ...
  function initStorage() {
    ...
    Lampa.Storage.set(
      "online_mod_proxy_videoseed",
      Lampa.Platform.is("android") || isLocal ? "false" : "true",
    );
    Lampa.Storage.set(
      "online_mod_proxy_vibix",
      Lampa.Platform.is("android") ? "false" : "true",
    );
    Lampa.Storage.set(
      "online_mod_proxy_redheadsound",
      Lampa.Platform.is("android") ? "false" : "true",
    );
    ...
    Lampa.Lang.add({
      ...
      online_mod_filmix_modal_text: {
        ru:
          ...
          filmixHost +
          "/consoles в вашем авторизованном аккаунте!",
        uk:
          "Введіть його на сторінці " +
          filmixHost +
          "/consoles у вашому авторизованому обліковому записі!",
        be:
          "Увядзіце яго на старонцы " +
          filmixHost +
          "/consoles у вашым аўтарызаваным акаўнце!",
        en:
          "Enter it at " + filmixHost + "/consoles in your authorized account!",
  ...
  function checkCurrentFanserialsHost(onComplite) {
    ...
    network.timeout(10000);
    network["native"](
      Utils.proxyLink(url, prox, prox_enc, "enc2t"),
      function (json) {
  ...
  function initMain() {
    ...
    if (Lampa.Storage.get("online_mod_use_stream_proxy", "") === "") {
      $.ajax({
        url:
          (window.location.protocol === "https:" ? "https://" : "http://") +
          "ipwho.is/?fields=ip,country_code",
        jsonp: "callback",
        dataType: "jsonp",
      }).done(function (json) {
  ...
  function checkPro(token, call) {
    ...
    network["native"](
      Utils.proxyLink(
        api_url + "user_profile" + Utils.filmixToken(dev_id, token),
        filmix_prox,
        filmix_prox_enc,
        "enc2t",
      ),
        ...
        e.body
          ...
          .on("hover:enter", function () {
            ...
            if (filmix_prox) {
              filmix_prox_enc +=
                "param/User-Agent=" +
                encodeURIComponent(Utils.filmixUserAgent()) +
                "/";
            }

            var modal = $(
              '<div><div class="broadcast__text">' +
                Lampa.Lang.translate("online_mod_filmix_modal_text") +
                '</div><div class="broadcast__device selector" style="text-align: center">' +
                Lampa.Lang.translate("online_mod_filmix_modal_wait") +
                '...</div><br><div class="broadcast__scan"><div></div></div></div></div>',
            );
            Lampa.Modal.open({
              title: "",
              html: modal,
              ...
              onSelect: function onSelect() {
                Lampa.Utils.copyTextToClipboard(
                  ...
                  function () {
                    Lampa.Noty.show(
                      Lampa.Lang.translate("online_mod_filmix_copy_secuses"),
                    );
                  },
                  function () {
                    Lampa.Noty.show(
                      Lampa.Lang.translate("online_mod_filmix_copy_fail"),
                    );
                  },
                );
              },
            ...
            ping_auth = setInterval(function () {
              checkPro(user_token, function () {
                ...
                e.body
                  .find('[data-name="filmix_token"] .settings-param__value')
                  .text(user_token);
                Lampa.Controller.toggle("settings_component");
              });
            }, 10000);
            ...
            network["native"](
              Utils.proxyLink(
                api_url + "token_request" + Utils.filmixToken(dev_id, ""),
                filmix_prox,
                filmix_prox_enc,
                "enc2t",
              ),
              function (found) {
                if (found && found.status == "ok") {
                  ...
                  modal
                    .find(".selector")
                    .text(Lampa.Lang.translate("network_401"));
              ...
              function (a, c) {
                ...
                modal
                  .find(".selector")
                  .text(
                    Lampa.Lang.translate("network_noconnect") +
                      ": " +
                      network.errorCode(a),
                  );
                modal.find(".broadcast__scan").remove();
  ...
  function rezka2Login(success, error) {
    ...
    var postdata =
      "login_name=" +
      encodeURIComponent(Lampa.Storage.get("online_mod_rezka2_name", ""));
    postdata +=
      "&login_password=" +
      encodeURIComponent(Lampa.Storage.get("online_mod_rezka2_password", ""));
    ...
    network.silent(
      ...
      function (json) {
        if (
          ...
          (json.success ||
            json.message ==
              "Уже авторизован на сайте. Необходимо обновить страницу!")
        ) {
          ...
          network.silent(
            ...
            function (str) {
              ...
              if (verify_form) {
                Lampa.Noty.show(
                  Lampa.Lang.translate("online_mod_unsupported_mirror") +
                    " HDrezka",
                );
  ...
  function rezka2FillCookie(success, error) {
    ...
    network["native"](
      ...
      function (json) {
        ...
        body =
          typeof body === "string" ? Lampa.Arrays.decodeJson(body, {}) : body;
        ...
        var cookieHeaders =
          (json && json.headers && json.headers["set-cookie"]) || null;
        ...
        if (cookie) {
          ...
          network.timeout(8000);
          network["native"](
            Utils.proxyLink(host + "/", prox, prox_enc2, "enc2t"),
            function (str) {
              var json =
                typeof str === "string"
                  ? Lampa.Arrays.decodeJson(str, {})
                  : str;
              var body = ((json && json.body) || "").replace(/\n/g, "");
              var error_form = body.match(
                /(<div class="error-code">[^<]*<div>[^<]*<\/div>[^<]*<\/div>)\s*(<div class="error-title">[^<]*<\/div>)/,
              );
              ...
              if (verify_form) {
                ...
                try {
                  verify_cookie = (0, eval)(
                    '"use strict"; (function(name, value){ return {name: name, value: value}; })' +
                      verify_form[1] +
                      ";",
                  );
                } catch (e) {}
                ...
                if (verify_cookie) {
                  ...
                  network.timeout(8000);
                  network["native"](
                    Utils.proxyLink(host + "/", prox, prox_enc3, "enc2t"),
                    function (str) {
                      var json =
                        typeof str === "string"
                          ? Lampa.Arrays.decodeJson(str, {})
                      ...
                      var cookieHeaders =
                        (json && json.headers && json.headers["set-cookie"]) ||
                        null;
  ...
  function fancdnFillCookie(success, error) {
    ...
    var postdata =
      "login_name=" +
      encodeURIComponent(Lampa.Storage.get("online_mod_fancdn_name", ""));
    postdata +=
      "&login_password=" +
      encodeURIComponent(Lampa.Storage.get("online_mod_fancdn_password", ""));
    ...
    network["native"](
      ...
      function (str) {
        ...
        var sid = "";
        var json =
          typeof str === "string" ? Lampa.Arrays.decodeJson(str, {}) : str;
        var body = ((json && json.body) || "").replace(/\n/g, "");
        var error_form = body.match(
          /(<div class="berrors-inner">[^<]*<b class="berrors-title">[^<]*<\/b>[^<]*<\/div>)/,
        );
  ...
  function initSettings() {
    ...
    Lampa.Settings.listener.follow("open", function (e) {
      if (e.name == "online_mod") {
        var clear_last_balanser = e.body.find(
          '[data-name="online_mod_clear_last_balanser"]',
        );
        clear_last_balanser
          .unbind("hover:enter")
          .on("hover:enter", function () {
            ...
            $(".settings-param__status", clear_last_balanser)
        ...
        rezka2_login.unbind("hover:enter").on("hover:enter", function () {
          var rezka2_login_status = $(".settings-param__status", rezka2_login)
            .removeClass("active error wait")
            .addClass("wait");
          rezka2Login(
            function () {
        ...
        var rezka2_logout = e.body.find(
          '[data-name="online_mod_rezka2_logout"]',
        );
        rezka2_logout.unbind("hover:enter").on("hover:enter", function () {
          var rezka2_logout_status = $(".settings-param__status", rezka2_logout)
            .removeClass("active error wait")
            .addClass("wait");
          rezka2Logout(
            function () {
              rezka2_logout_status
                .removeClass("active error wait")
                .addClass("active");
            },
            function () {
        ...
        var rezka2_fill_cookie = e.body.find(
          '[data-name="online_mod_rezka2_fill_cookie"]',
        );
        rezka2_fill_cookie.unbind("hover:enter").on("hover:enter", function () {
          var rezka2_fill_cookie_status = $(
          ...
          rezka2FillCookie(
            function () {
              rezka2_fill_cookie_status
                .removeClass("active error wait")
                .addClass("active");
              Lampa.Params.update(
                e.body.find('[data-name="online_mod_rezka2_cookie"]'),
                [],
                e.body,
              );
            },
        ...
        var fancdn_fill_cookie = e.body.find(
          '[data-name="online_mod_fancdn_fill_cookie"]',
        );
        fancdn_fill_cookie.unbind("hover:enter").on("hover:enter", function () {
          var fancdn_fill_cookie_status = $(
            ".settings-param__status",
            fancdn_fill_cookie,
          )
            .removeClass("active error wait")
          ...
          fancdnFillCookie(
            function () {
              fancdn_fill_cookie_status
                .removeClass("active error wait")
                .addClass("active");
              Lampa.Params.update(
                e.body.find('[data-name="online_mod_fancdn_cookie"]'),
                [],
                e.body,
              );
            },
